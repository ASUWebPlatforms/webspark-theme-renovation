...
div[class^=uds-hero].has-btn-row .hero {
  grid-row: 1/span 4;
}
...
div[class^=uds-hero].has-btn-row .btn-row .btn, div[class^=uds-hero].has-btn-row .btn-row .uds-modal-close-btn {
  white-space: normal;
}
...
div.uds-hero-sm.has-btn-row {
  grid-template-rows: 1rem 13.9rem auto 1rem;
}
...
div.uds-hero-md [role=doc-subtitle] {
  display: none;
}
div.uds-hero-md h1,
div.uds-hero-md a.btn,
div.uds-hero-md a.uds-modal-close-btn,
div.uds-hero-md .btn-row {
  z-index: 30;
}
div.uds-hero-md.has-btn-row {
  grid-template-rows: 1rem 19rem auto 1rem;
}
div.uds-hero-md.has-btn-row .hero {
  grid-row: unset;
  position: absolute;
  height: 21rem;
  top: 0;
...
div.uds-hero-lg h1,
div.uds-hero-lg [role=doc-subtitle],
div.uds-hero-lg a.btn,
div.uds-hero-lg a.uds-modal-close-btn,
div.uds-hero-lg .content,
div.uds-hero-lg .btn-row {
  z-index: 30;
}
div.uds-hero-lg .content {
  margin-top: 0;
...
div.uds-hero-lg.has-btn-row {
  grid-template-rows: 1rem 19rem 11rem auto 1rem;
}
div.uds-hero-lg.has-btn-row h1 {
  -ms-flex-item-align: end;
      align-self: flex-end;
}
...
div[class^=uds-hero] .btn-row {
  ...
  div[class^=uds-hero] a.btn + a.btn, div[class^=uds-hero] a.uds-modal-close-btn + a.btn, div[class^=uds-hero] a.btn + a.uds-modal-close-btn, div[class^=uds-hero] a.uds-modal-close-btn + a.uds-modal-close-btn {
    margin-left: 1rem;
  }
  div[class^=uds-hero].hide-content .content {
    display: block;
  ...
  div.uds-hero-sm.has-btn-row {
    grid-template-rows: 1rem 13.4rem auto 1rem;
  }
  div.uds-hero-sm.has-btn-row .btn-row {
    top: 24px;
  ...
  div.uds-hero-md.has-btn-row {
    grid-template-rows: 1rem 1fr auto auto 3rem;
  }
  div.uds-hero-md.has-btn-row .hero {
    grid-row: 1/span 5;
    position: initial;
  ...
  div.uds-hero-lg.has-btn-row .hero {
    height: 42.75rem;
  }
  div.uds-hero-lg.has-btn-row h1 {
    margin-bottom: 1rem;
